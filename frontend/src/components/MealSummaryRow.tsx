        ...
        <CardContent>
            <Grid container spacing={3} direction="row">
                ...
                <Grid item xs={1.5}>
                    ...
                    <Typography variant="body1" sx={{ mb: 1.5 }} color="text.secondary">{address}</Typography>
                </Grid>
                <Grid item xs={3}>
                ...
                <Grid item xs={1.5}>
                    <Typography variant="h4" gutterBottom>Capacity</Typography>
                ...
                <Grid item xs={2}>
                    <Box sx={{ textAlign: "center" }}>
                        ...
                        <Button variant="contained" color='primary' component={Link} to={`/viewpost/${id}`}>View Meal</Button>
                    </Box>
                </Grid>
            </Grid>
        </CardContent>
